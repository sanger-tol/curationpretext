...
workflow HIC_MINIMAP2 {
    ...
    //          csv_ch is generated by generate_cram_csv found in line 42 of the GENERATE_MAPS subworkflow
    //          data = $crampath ${crampath}.crai, ${from} (container number), ${to} (container number), ${base}, ${chunkn}, ${rgline}
    //
    // csv_ch
    //     .splitCsv()
